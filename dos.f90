...
!=============================================================================== 
 ...
 use od_cell,       only : nkpoints, kpoint_weight
 ...
 if(fixed)then
write(stdout,'(1x,a1,a46,f12.4,a3,15x,a1)')"|", " Band energy (Fixed broadening)  : ",calc_band_energies(dos_fixed),"eV","|"
 endif
 if(adaptive)then
write(stdout,'(1x,a1,a46,f12.4,a3,15x,a1)')"|", " Band energy (Adaptive broadening) : ",calc_band_energies(dos_adaptive),"eV","|"
 endif
 if(linear)then 
write(stdout,'(1x,a1,a46,f12.4,a3,15x,a1)')"|", " Band energy (Linear broadening) : ",calc_band_energies(dos_linear),"eV","|"
 endif
...
write(stdout,'(1x,a1,a46,f12.4,a3,15x,a1)')"|", " Band energy (Freom CASTEP) : ", eband,"eV","|"
...
!===============================================================================
 ...
 use od_cell,       only : kpoint_grid_dim,nkpoints,kpoint_weight
 ...
 integer :: i,ik,is,ib,idos,ierr,iorb
 integer :: m,n,o,nn
