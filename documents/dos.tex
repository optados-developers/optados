...
\subsection[spectral\_scheme]{\tt character(len=50) :: spectral\_scheme}

Which method to use compute dos etc
...
\subsection[smearing\_width]{\tt real(kind=dp) :: smearing\_width}
Smearing width for broadening

If $\verb#spectral_scheme# = \verb#fixed#$ default value is 0.5eV, else
default value is 0.0eV

\subsection[scissor\_op]{\tt real(kind=dp) :: scissor\_op}
Value of the scissor operator. 

Default value is 0eV
